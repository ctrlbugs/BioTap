      ...
      <div className={`mobile-sidebar ${mobileMenuOpen ? 'active' : ''}`} id="mobileSidebar">
        ...
        <div className="mobile-sidebar-social">
          ...
          <div className="mobile-social-links">
            <a href="instagram.com/biotap_app" className="instagram" aria-label="Instagram" target="_blank">
            ...
            <a href="x.com/biotapapp" className="twitter" aria-label="X (Twitter)" target="_blank">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
