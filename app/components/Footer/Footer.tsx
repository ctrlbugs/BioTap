    ...
    <footer className="footer">
      ...
      <div className="footer-bottom">
        ...
        <div className="social-links">
          <a href="https://instagram.com/biotap_app" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
          ...
          <a href="https://linkedin.com/company/biotap-services-limited/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a href="https://x.com/biotapapp" target="_blank" rel="noopener noreferrer" aria-label="X">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
